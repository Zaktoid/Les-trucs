...
int main(int argc, char **argv) {
    ...
    //Compute compression
    float** filteredY = apply_wavelet_compression(Y_array,width,height,4,0.5);
    float** filteredCb = apply_wavelet_compression(Cb,width,height,4,0.5);
    float** filteredCr = apply_wavelet_compression(Cr,width,height,4,0.5);
